...
public class AnimalsHistory implements Parcelable {
    ...
    public AnimalsHistory(int id, String pet_name, String desc, int pet_age, String pet_category, String pet_gender, String pet_photo, float pet_height, float pet_weight) {
        this.id = id;
    ...
    protected AnimalsHistory(Parcel in) {
        this.id = in.readInt();
    ...
    public static final Parcelable.Creator<AnimalsHistory> CREATOR = new Parcelable.Creator<AnimalsHistory>() {
        @Override
        public AnimalsHistory createFromParcel(Parcel source) {
            return new AnimalsHistory(source);
        }

        @Override
        public AnimalsHistory[] newArray(int size) {
            return new AnimalsHistory[size];
        }
    };
}
